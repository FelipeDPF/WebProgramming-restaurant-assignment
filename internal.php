...
if($_SESSION['submit']==null) {
	...
	echo "<script type='text/javascript'>window.top.location='http://depa0028.com/CST8238/Restaurant/login.php';</script>";
}
else{
	echo "<h1>Session state Data</h1>";
	echo "<form method=\"post\" background = \"black\">";
	echo "<table>";
	echo "<tr>";
	echo "<td><b>Username: </b>" . $_SESSION["username"] . "<br/></td></tr>";
	echo "<td><b>Admin Level: </b>" . $_SESSION["AdminLevel"] . "<br/></td></tr>";
	echo "<td><b>Last Login: </b>" . $_SESSION["Lastlogin"] .  "<br/></td></tr>";
	echo "<td><input type= \"submit\" name = \"submit\" value = \"LOGOUT\"><td></tr>";

	if(isset($_POST['submit'])){
		header('Location: logout.php');
		echo "<script type='text/javascript'>window.top.location='http://depa0028.com/CST8238/Restaurant/logout.php';</script>";
	}
}
echo "</table></form>";
